...
<footer class="main-footer">
    <div class="footer clearfix mb-0 text-muted">
        <div class="float-start">
            <p>&copy; Copyright 2025 - <?= date("Y"); ?> <a href="https://github.com/armandwipangestu/ci3-boilerplate" target="_blank"><?= getenv('APP_NAME'); ?></a>. All rights reserved.</p>
        </div>
        <div class="float-end">
            <p>
                Developed with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span> By
                <a href="https://github.com/armandwipangestu" target="_blank">Abubakar</a>
            </p>
        </div>
    </div>
</footer>
